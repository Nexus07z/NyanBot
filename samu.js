...
╰─ *FIN LISTA DE MENUS*
`
samu330.sendMessage(from, Menu, MessageType.text, {quoted:
{ key: {
fromMe: false,
participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
},
