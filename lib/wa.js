...
exports.sendFakeStatus2 = (from, teks) => {
        samu330.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": 'Sam | Nexusᴮᴼᵀ', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
}
...
exports.sendPdf = async(from, buffer, title = "Nexus.pdf") => {
