...
exports.connect = async() => {
    ...
    samu330.on('connecting', () => {
        console.log(chalk.whiteBright("⌛"), chalk.keyword("red")("□ Estado de Nexusᴮᴼᵀ"), chalk.keyword("aqua")("Conectando..."))
    })
        samu330.on('open', () => {
        ...
        console.log(chalk.keyword("green")("│"), chalk.keyword("red")('│'), chalk.keyword("blue")(' Samu330 | MankBarBar'))
        console.log(chalk.keyword("green")("│"), chalk.keyword("red")('╰╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╯'))
